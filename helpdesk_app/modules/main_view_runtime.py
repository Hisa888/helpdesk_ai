...
def render_admin_tools_if_logged_in(
    *,
    ...
    read_interactions: Callable,
    count_nohit_logs: Callable,
    list_log_files: Callable,
    make_logs_zip: Callable,
    load_nohit_questions_from_logs: Callable,
    generate_faq_candidates: Callable,
    append_faq_csv: Callable,
    seed_nohit_questions: Callable,
    faq_path,
) -> None:
